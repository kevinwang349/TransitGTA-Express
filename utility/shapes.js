...
function init() {
    ...
    for (let i = 1; i < routes.length; i++) {
        routelats.push([routes[i][routes[0].indexOf('route_short_name')]])
        routelons.push([routes[i][routes[0].indexOf('route_short_name')]])
        branches.push([routes[i][routes[0].indexOf('route_short_name')]])
