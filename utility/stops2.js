...
function initGO() {
    ...
    /*for(let i=1;i<routes.length;i++){
        ...
        for(let j=1;j<newtimes.length;j++){
            ...
            if(tripids.includes(newtimes[j][newtimes[0].indexOf('trip_id')])&&!stopids.includes(stopid)){
                stopids.push(stopid);
                const stop=findRow(stops,'stop_id',stopid);
    ...
    console.log(findRow(stops,'stop_id','9700'));
    console.log(findRow(stops,'stop_id','9844'));
    console.log(findRow(stops,'stop_code','9700'));
    console.log(findRow(stops,'stop_code','9844'));
