    ...
    map.on('moveend', async () => {
        if(map.getZoom()>13){
            ...
            for(let i=1;i<stops.length;i++){
                ...
                let pop=`<div style="font-size:20px;">#${currentStop[stops[0].indexOf('stop_code')]}: ${currentStop[stops[0].indexOf('stop_name')]}<br><a href='https://transitGTA.onrender.com/${agency}/stopschedule?s=${currentStop[stops[0].indexOf('stop_id')]}'>Stop schedule for this stop</a><br><a href='https://transitGTA.onrender.com/${agency}/nextbus?s=${currentStop[stops[0].indexOf('stop_id')]}'>Next vehicle arrival at this stop</a></div>`;
