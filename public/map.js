...
async function generateMap(){
    ...
    for(let i=1;i<stops.length;i++){
        ...
        let pop=`#${currentStop[stops[0].indexOf('stop_code')]}: ${currentStop[stops[0].indexOf('stop_name')]}<br><a href='https://transitGTA.kevinwang21.repl.co/stopschedule/?a=${agency}&s=${currentStop[stops[0].indexOf('stop_id')]}'>Stop schedule for this stop</a><br><a href='https://transitGTA.kevinwang21.repl.co/nextbus/?a=${agency}&s=${currentStop[stops[0].indexOf('stop_id')]}'>Next vehicle arrival at this stop</a>`;
